...
class bus_booking:
    ...
    def cover_page(self):
        ...
        Label(root, text="\n\n\n\n\nName: PRIYANSHI JAGATI", font='Arial 16 bold', fg='blue').pack()
        Label(root, text="\nEnr : 211B229", font='Arial 16 bold', fg='blue').pack()
                                            ...
                                            if len(name)>0 and len(name)<20:
                                                if age>0 and age<150:
                                                    if seats>0 and seats<16:
                                                        ...
                                                        showerror("booking limit exceed","you can only book upto 15 seats")
                                                else:
